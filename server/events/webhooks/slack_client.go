...
//go:generate pegomock generate -m --package mocks -o mocks/mock_slack_client.go SlackClient
...
//go:generate pegomock generate -m --package mocks -o mocks/mock_underlying_slack_client.go UnderlyingSlackClient
